  ...
  const offices = [
    {
      ...
      email: "lagos@lorinsconsults.com",
      hours: "Monday - Friday: 8:00 AM - 5:00 PM",
    },
    {
      city: "Abuja",
      address: "45 Ahmadu Bello Way, Central Business District, Abuja",
      phone: "+234 123 456 7891",
      email: "abuja@lorinsconsults.com",
      hours: "Monday - Friday: 8:00 AM - 5:00 PM",
    },
    {
      city: "Port Harcourt",
      address: "78 Aba Road, GRA Phase 2, Port Harcourt",
      phone: "+234 123 456 7892",
      email: "portharcourt@lorinsconsults.com",
      hours: "Monday - Friday: 8:00 AM - 5:00 PM",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-gray-600 mb-10 leading-relaxed">
                Have questions or need more information about our services? Our
                team is ready to assist you. Feel free to reach out using any of
                the methods below, or visit one of our offices.
              </p>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">+234 123 456 7891</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">info@lorinsconsults.com</p>
                    <p className="text-gray-600">support@lorinsconsults.com</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors duration-300"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-700">
              Visit us at one of our offices across Nigeria
            </p>
          </div>
